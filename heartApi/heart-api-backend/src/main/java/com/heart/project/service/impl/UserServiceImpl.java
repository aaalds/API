...
import static com.heart.project.constant.UserConstant.ADMIN_ROLE;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User>
    ...
    @Resource
    private com.heart.project.mapper.UserMapper userMapper;
     ...
     * 盐值，混淆密码
     */
    private static final String SALT = "heart";
    ...
    public long userRegister(String userAccount, String userPassword, String checkPassword) {
        ...
        synchronized (userAccount.intern()) {
            // 账户不能重复
            int count = userMapper.selectUserCount(userAccount);
            if (count > 0) {
            ...
            String imgurl = (String) map.get("text");
